...
namespace EdwinSaa_MVC_Veterinaria_ExamenP1_P4.Controllers
{
    public class PetsController : Controller
    {
        ...
        public PetsController(SQLServerContextSJCP context)
        {
            _context = context;
        }
        ...
        {
            var sQLServerContextSJCP = _context.Pet.Include(p => p.Owner);
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,Species,Breed,BirthDate,OwnerId")] Pet pet)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,Species,Breed,BirthDate,OwnerId")] Pet pet)
        {
            if (id != pet.Id)
            {
                return NotFound();
